...
void loop()
{
  ...
  double xDegrees = xRate / 14.375 + xOffset;
  double yDegrees = yRate / 14.375 + yOffset;
  double zDegrees = zRate / 14.375 + zOffset;
  ...
  x += xDegrees * (rate * 0.001); // Degrees / Sec * Sec
  y += yDegrees * (rate * 0.001); // Degrees / Sec * Sec
  z += zDegrees * (rate * 0.001); // Degrees / Sec * Sec
